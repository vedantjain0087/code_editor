  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>216/222</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L420'></a><a href='#L420'>420</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { editorOptions, editorEvents, getAceInstance,debounce } from './editorOptions.js'
...
<span class="cstat-no" title="statement not covered" >      this.o</span>nChange = this.debounce(this.onChange, this.props.debounceChangePeriod);
    }
    split.forEach((editor, index) =&gt; {
      ...
      editor.setValue(defaultValueForEditor === undefined ? valueForEditor : <span class="branch-1 cbranch-no" title="branch not covered" >defaultValueForEditor, c</span>ursorStart);
...
&nbsp;
    if (nextProps.orientation !== oldProps.orientation) {
      split.setOrientation(nextProps.orientation === 'below' ? <span class="branch-0 cbranch-no" title="branch not covered" >split.BELOW : s</span>plit.BESIDE);
    }
&nbsp;
    split.forEach((editor, index) =&gt; {
...
<span class="cstat-no" title="statement not covered" >          editor.s</span>etKeyboardHandler(null);
        }
      }
...
<span class="cstat-no" title="statement not covered" >      this.e</span>ditor.resize();
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.p</span>rops.onInput(event);
    }
  }
&nbsp;
  onBlur(event) {
